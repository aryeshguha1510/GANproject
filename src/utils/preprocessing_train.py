...
directory = r'C:\Users\aryes\Desktop\YEAR 2\mrm\datasets\DID-dataset\DID-MDN-training\Rain_Light\train2018new'

# Create a directory to store the separated images
output_directory = r'C:\Users\aryes\Desktop\YEAR 2\mrm\GANproject\dataset\train_data'
